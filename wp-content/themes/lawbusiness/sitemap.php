...
if ($cmsms_option[CMSMS_SHORTNAME . '_sitemap_s_categs']) {
	echo '<h2>' . __('Services Archives by Categories', 'cmsmasters') . '</h2>' . 
		'<ul class="cmsms_sitemap_category">';
...
if ($cmsms_option[CMSMS_SHORTNAME . '_sitemap_s_tags']) {
	echo '<h2>' . __('Services Archives by Tags', 'cmsmasters') . '</h2>' . 
		'<ul class="cmsms_sitemap_archive">';
