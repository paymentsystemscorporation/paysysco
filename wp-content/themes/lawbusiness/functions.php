...
define('CMSMS_SHORTNAME', 'lawbusiness');
define('CMSMS_FULLNAME', 'LawBusiness');
...
require_once(CMSMS_CLASS . '/services-posttype.php');
...
function cmsms_google_fonts_list() {
	$fonts = array( 
		'' => __('None', 'cmsmasters'), 
		'Playfair+Display:400,700,400italic,700italic' => 'Playfair Display', 
		...
		'Lato:300,400,400italic,700,700italic' => 'Lato', 
