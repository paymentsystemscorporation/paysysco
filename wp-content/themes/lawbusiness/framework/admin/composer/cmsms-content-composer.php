...
function show_cmsms_composer_meta_box() {
	...
	'<div class="cmsms_composer_container">' . 
		...
		'<input type="hidden" id="cmsms_composer_check_column_text" name="cmsms_composer_check_column_text" value="' . __('Animation effects', 'cmsmasters') . '" />' . 
