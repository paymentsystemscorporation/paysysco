		...
		<div class="media-item">
			...
			<?php } else if ($type == 'color') { ?>
					...
					<tr>
						...
						<td class="field" style="padding-top:10px;">
							<input type="text" value="<?php echo ($content != '' && $color['bgcolor']) ? $color['bgcolor'] : '#b27ca3'; ?>" name="cb_glow" id="cb_glow" class="popup_tr_value my-color-field" aria-required="true" data-default-color="#b27ca3" />
						</td>
					</tr>
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
