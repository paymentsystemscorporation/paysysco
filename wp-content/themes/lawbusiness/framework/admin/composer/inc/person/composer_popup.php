	...
	function insertShortcode() { 
		if (window.tinyMCE) {
			...
			var shortcode_tag = '', 
				...
				pb_block_link = jQuery('#pb_block_link').val(),
				pb_block_button_text = jQuery('#pb_block_button_text').val(),
			...
			if (pb_block_button_text !== '') {
				shortcode_tag += ' block_button_text="' + pb_block_button_text + '"';
			}

			if (pb_block_link !== '') {
				shortcode_tag += ' link="' + pb_block_link + '"';
			}
			...
			<table class="describe">
				<tbody>
					...
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
							<span class="alignleft">
								<label for="pb_block_button_text"><?php _e('Button Text', 'cmsmasters'); ?></label>
							</span>
						</th>
						<td class="field" style="padding-top:10px;">
							<input type="text" value="<?php echo ($content != '' && $block['block_button_text']) ? $block['block_button_text'] : ''; ?>" name="pb_block_button_text" id="pb_block_button_text" class="popup_tr_value" />
						</td>
					</tr>
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
							<span class="alignleft">
								<label for="pb_block_link"><?php _e('Block Link', 'cmsmasters'); ?></label>
							</span>
						</th>
						<td class="field" style="padding-top:10px;">
							<input type="text" value="<?php echo ($content != '' && $block['link']) ? $block['link'] : ''; ?>" name="pb_block_link" id="pb_block_link" class="popup_tr_value" />
						</td>
					</tr>
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
