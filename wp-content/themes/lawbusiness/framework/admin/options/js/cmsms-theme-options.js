 ...
 * 
 * Post, Page, Service & Testimonial Options Scripts
...
jQuery(document).ready(function () { 
	...
	jQuery('.cmsms_tr_radio_img_pj input[type="radio"]').bind('change', function () { 
		var s_size = jQuery(this).attr('data-size');
		
		
		jQuery(this).closest('tr.cmsms_tr_radio_img_pj').find('span.description > strong.s_size').text(s_size);
