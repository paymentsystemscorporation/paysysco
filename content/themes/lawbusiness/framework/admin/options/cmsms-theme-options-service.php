...
$cmsms_global_services_service_share_box = (isset($cmsms_option[CMSMS_SHORTNAME . '_services_service_share_box']) && $cmsms_option[CMSMS_SHORTNAME . '_services_service_share_box'] !== '') ? (($cmsms_option[CMSMS_SHORTNAME . '_services_service_share_box'] == 1) ? 'true' : 'false') : 'true';
$cmsms_global_services_service_author_box = (isset($cmsms_option[CMSMS_SHORTNAME . '_services_service_author_box']) && $cmsms_option[CMSMS_SHORTNAME . '_services_service_author_box'] !== '') ? (($cmsms_option[CMSMS_SHORTNAME . '_services_service_author_box'] == 1) ? 'true' : 'false') : 'true';
...
if (isset($cmsms_option[CMSMS_SHORTNAME . '_services_more_services_box']) && $cmsms_option[CMSMS_SHORTNAME . '_services_more_services_box'] !== '') {
	$cmsms_global_services_more_services_box = array();
	
	foreach($cmsms_option[CMSMS_SHORTNAME . '_services_more_services_box'] as $key => $val) {
		if ($val == 'true') {
			$cmsms_global_services_more_services_box[] = $key;
		}
	}
} else {
	$cmsms_global_services_more_services_box = array( 
...
$cmsms_option_name = 'cmsms_service_';


if ($cmsms_global_seo) {
	$tabs_array = array( 
		'cmsms_service' => array( 
			'label' => __('Service', 'cmsmasters'), 
			'value'	=> 'cmsms_service' 
		), 
		'cmsms_layout' => array( 
...
$custom_service_meta_fields = array( 
	array( 
		'id'	=> 'cmsms_service_images', 
		'type'	=> 'content_start', 
		'box'	=> 'true', 
		'hide'	=> 'true' 
	), 
	array( 
		'label'	=> __('Service Images', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Format', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Features 1 Title', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Features 1', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Features 2 Title', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Features 2', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Features 3 Title', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Features 3', 'cmsmasters'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> __('Service Features 4 Title', 'cmsmasters'), 
		'desc'	=> '', 
		'id'	=> $cmsms_option_name . 'features_four_title', 
		'type'	=> 'text_long', 
		'hide'	=> '', 
		'std'	=> '' 
	), 
	array( 
		'label'	=> __('Service Features 4', 'cmsmasters'), 
		'desc'	=> '', 
		'id'	=> $cmsms_option_name . 'features_four', 
		'type'	=> 'repeatable_multiple', 
		'hide'	=> '', 
		'std'	=> '' 
	), 
	array( 
		'label'	=> __('Service Features 5 Title', 'cmsmasters'), 
		'desc'	=> '', 
		'id'	=> $cmsms_option_name . 'features_five_title', 
		'type'	=> 'text_long', 
		'hide'	=> '', 
		'std'	=> '' 
	), 
	array( 
		'label'	=> __('Service Features 5', 'cmsmasters'), 
		'desc'	=> '', 
		'id'	=> $cmsms_option_name . 'features_five', 
		'type'	=> 'repeatable_multiple', 
		'hide'	=> '', 
		'std'	=> '' 
	), 
	array( 
		'label'	=> __("Service Link Button Text", 'cmsmasters'), 
		'desc'	=> '', 
		'id'	=> $cmsms_option_name . 's_link_text', 
		'type'	=> 'text', 
		'hide'	=> '', 
		'std'	=> __('Click Here', 'cmsmasters') 
	), 
	array( 
		'label'	=> __("Service Link Button URL", 'cmsmasters'), 
		'desc'	=> '', 
		'id'	=> $cmsms_option_name . 's_link_url', 
		'type'	=> 'text_long', 
		'hide'	=> '', 
		'std'	=> '' 
	), 
	array( 
		'label'	=> __("Service Link Target", 'cmsmasters'), 
		'desc'	=> __('Open link in a new tab', 'cmsmasters'), 
		'id'	=> $cmsms_option_name . 's_link_target', 
		'type'	=> 'checkbox', 
		'hide'	=> '', 
		'std'	=> 'true' 
	), 
	array( 
		...
		'type'	=> 'checkbox', 
		'hide'	=> '', 
		'std'	=> $cmsms_global_services_service_share_box 
	), 
	array( 
		...
		'type'	=> 'checkbox', 
		'hide'	=> '', 
		'std'	=> $cmsms_global_services_service_author_box 
	), 
	array( 
		...
		'type'	=> 'checkbox_group', 
		'hide'	=> '', 
		'std'	=> ((isset($_GET['post']) && get_post_meta($_GET['post'], 'cmsms_heading', true)) ? '' : $cmsms_global_services_more_services_box), 
		'options' => array( 
			'related' => array( 
...
function add_custom_service_meta_box() {
    add_meta_box( 
		'cmsms_service_meta_box', 
		__('Cmsmasters Service Options', 'cmsmasters'), 
		'show_cmsms_meta_box', 
		'service', 
		'normal', 
		'high' 
