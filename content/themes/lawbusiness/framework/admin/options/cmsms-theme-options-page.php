...
$cmsms_global_bg = (isset($cmsms_option[CMSMS_SHORTNAME . '_boxed']) && $cmsms_option[CMSMS_SHORTNAME . '_boxed'] !== '') ? (($cmsms_option[CMSMS_SHORTNAME . '_boxed'] == 1) ? true : false) : false;
...
$custom_page_meta_fields = array( 
	...
	array( 
		'label'	=> __('Services Filter & Sort', 'cmsmasters'), 
	...
	array( 
		'label'	=> __('Services Type', 'cmsmasters'), 
		'desc'	=> __('If you do not choose any of the service types, then this page will show all the services.', 'cmsmasters'), 
		'id'	=> $cmsms_option_name . 'service_type', 
...
function add_custom_page_meta_box() {
    add_meta_box( 
		'cmsms_page_meta_box', 
		__('Cmsmasters Page Options', 'cmsmasters'), 
		'show_cmsms_meta_box', 
		'page', 
		'normal', 
		'high' 
