...
require_once(CMSMS_SETTINGS . '/cmsms-theme-settings-services.php');
...
function cmsms_get_settings() {
	...
	case CMSMS_PAGE_BASENAME . '-blog':
		...
		break;
	case CMSMS_PAGE_BASENAME . '-services':
		$cmsms_option_name = 'cmsms_options_' . CMSMS_SHORTNAME . '_services';
		$cmsms_settings_page_title = __('Theme Services Settings', 'cmsmasters');
		$cmsms_page_sections = cmsms_options_services_sections();
		$cmsms_page_fields = cmsms_options_services_fields();
		$cmsms_page_tabs = cmsms_options_services_tabs();
		...
		case 'full':
			...
			break;
		case 'service':
			$cmsms_option_name = $cmsms_option_name . '_service';
...
function cmsms_add_menu() {
	...
	$cmsms_settings_services = add_submenu_page( 
		CMSMS_PAGE_BASENAME, 
		__('Theme Services Settings', 'cmsmasters'), 
		__('Services', 'cmsmasters'), 
		'manage_options', 
		CMSMS_PAGE_BASENAME . '-services', 
		'cmsms_settings_page_fn' 
	);
	
	add_action('load-' . $cmsms_settings_services, 'cmsms_settings_scripts');
...
function cmsms_form_field_fn($args = array()) {
	...
	case 'heading':
		...
		'<div class="icon_management">' . 
			...
			echo '</ul>' . 
			'<input id="heading_icons_number" type="hidden" name="' . $cmsms_option_name . '[' . $id . '_number]" value="' . ((isset($i)) ?  $i : '') . '" />' . 
		'</div>' . 
		'<script type="text/javascript">' . 
			'jQuery(document).ready(function () { ' . 
				'(function ($) { ' . 
...
function cmsms_add_global_options() {
	$cmsms_option_names = array( 
		...
		array( 
			'cmsms_options_' . CMSMS_SHORTNAME . '_services_full', 
			cmsms_options_services_fields('full') 
		), 
		array( 
			'cmsms_options_' . CMSMS_SHORTNAME . '_services_service', 
			cmsms_options_services_fields('service') 
		), 
		array( 
...
function cmsms_get_global_options() {
	...
	$cmsms_option_names = array( 
		...
		'cmsms_options_' . CMSMS_SHORTNAME . '_font_other', 
		'cmsms_options_' . CMSMS_SHORTNAME . '_icon_heading', 
		'cmsms_options_' . CMSMS_SHORTNAME . '_icon', 
		'cmsms_options_' . CMSMS_SHORTNAME . '_icon_social',
		'cmsms_options_' . CMSMS_SHORTNAME . '_blog_page', 
		'cmsms_options_' . CMSMS_SHORTNAME . '_blog_post', 
		'cmsms_options_' . CMSMS_SHORTNAME . '_services_full', 
