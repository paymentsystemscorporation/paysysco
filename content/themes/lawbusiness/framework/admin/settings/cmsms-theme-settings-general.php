...
function cmsms_options_general_fields($set_tab = false) {
	...
	case 'general':
		...
		$options[] = array( 
			'section' => 'general_section', 
			'id' => CMSMS_SHORTNAME . '_sec_theme_color', 
			'title' => __('Second Theme Color', 'cmsmasters'), 
			'desc' => '', 
			'type' => 'color', 
			'std' => '#000000' 
		);
		...
		$options[] = array( 
			'section' => 'general_section', 
			'id' => CMSMS_SHORTNAME . '_inview', 
			'title' => __('Animation Effects', 'cmsmasters'), 
			'desc' => __('enable', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
	...
	case 'sitemap':
		...
		$options[] = array( 
			'section' => 'sitemap_section', 
			'id' => CMSMS_SHORTNAME . '_sitemap_s_categs', 
			'title' => __('Services Archives by Categories', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
		...
		$options[] = array( 
			'section' => 'sitemap_section', 
			'id' => CMSMS_SHORTNAME . '_sitemap_s_tags', 
			'title' => __('Services Archives by Tags', 'cmsmasters'), 
			'desc' => __('show', 'cmsmasters'), 
			'type' => 'checkbox', 
			'std' => 1 
		);
	...
	case 'error':
		...
		$options[] = array( 
			...
			'title' => __('Error Page Background Color', 'cmsmasters'), 
			'desc' => '', 
			'type' => 'color', 
			'std' => '#5dbde0' 
		);
		...
		$options[] = array( 
			...
			'title' => __('Error Page Background Image', 'cmsmasters'), 
			'desc' => __('Choose your custom background image.', 'cmsmasters'), 
			'type' => 'upload', 
