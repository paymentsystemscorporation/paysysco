...
<script type="text/javascript">
	...
	function insertShortcode() { 
		if (window.tinyMCE) {
			...
			shortcode_tag += '[pricing_table title="' + price_title + 
			'" hot_price="' + ((hot_price.is(':checked')) ? 'true' : 'false') + 
			'" price="' + price_text_price + 
			'" buttontext="' + price_but_text + 
			'" buttonlink="' + price_but_link + '"';
			...
			<table class="describe">
				<tbody>
					...
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
							<span class="alignleft">
								<label for="hot_price"><?php _e('Hot Price', 'cmsmasters'); ?></label>
							</span>
						</th>
						<td class="field" style="padding-top:15px;">
							<input type="checkbox" value="true" name="hot_price" id="hot_price" class="popup_tr_value"<?php echo ($content != '') ? (($pricing_table['hot_price'] && $pricing_table['hot_price'] == 'true') ? ' checked="checked"' : '') : ''; ?> />
							<label for="hot_price"><?php _e('Highlight pricing table', 'cmsmasters'); ?></label>
						</td>
					</tr>
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
