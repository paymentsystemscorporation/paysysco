	...
	function insertShortcode() { 
		if (window.tinyMCE) {
			var shortcode_tag = '', 
				...
				clients_title = jQuery('#clients_title').val(), 
			...
			if (clients_title != '') {
				shortcode_tag += ' clients_title="' + clients_title + '"';
			}
					...
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
							<span class="alignleft">
								<label for="clients_title"><?php _e('Title', 'cmsmasters'); ?></label>
							</span>
						</th>
						<td class="field" style="padding-top:10px;">
							<input type="text" value="<?php echo ($content != '' && $clients['clients_title']) ? $clients['clients_title'] : ''; ?>" name="clients_title" id="clients_title" class="popup_tr_value" />
						</td>
					</tr>
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
