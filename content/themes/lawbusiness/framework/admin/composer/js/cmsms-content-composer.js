	...
	(function ($) { 
		...
		if ($('#cmsms_composer_content').hasClass('deactivated')) {
			...
			for (var i = 0, ilength = columns.length; i < ilength; i += 1) {
				...
				cAnimation = (columns.eq(i).attr('data-animation')) ? columns.eq(i).attr('data-animation') : '';
				...
				if (cFolder === 'divider') {
					columns.eq(i).before('<div class="' + cClass + '">' + 
						...
						'</div>' + 
						'<div class="cmsms_composer_column_elements" data-folder="' + cFolder + '" data-type="' + cType + '" data-animation="">' + 
					...
					columns.eq(i).before('<div class="' + cClass + '">' + 
						'<div class="cmsms_composer_column_head">' + 
							'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_delete" title="' + composerDeleteText + '">' + composerDeleteText + '</a>' + 
							'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_animation' + ((cClassArray.indexOf('right_column') !== -1) ? ' checked' : '') + '" title="' + composerCheckColumnText + '">' + composerCheckColumnText + '</a>' + 
							'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_copy" title="' + composerCopyText + '">' + composerCopyText + '</a>' + 
							...
							'<span class="cmsms_composer_column_title">' + cTitle + '</span>' + 
						'</div>' + 
						'<div class="cmsms_composer_column_elements" data-folder="' + cFolder + '" data-type="' + cType + '" data-animation="' + cAnimation + '">' + cElementContent + '</div>' + 
					'</div>');
				}
			...
			$('#cmsms_composer_content').droppable( { 
				...
				drop : function (event, ui) { 
					var dFolder = ui.draggable.attr('data-folder'), 
						...
						dAnimation = ui.draggable.attr('data-animation'), 
					...
					if (dFolder === 'divider') {
						ui.draggable.html('<div class="' + dClass + '">' + 
							...
							'</div>' + 
							'<div class="cmsms_composer_column_elements" data-folder="' + dFolder + '" data-type="' + dType + '" data-animation="">' + 
						...
						ui.draggable.html('<div class="' + dClass + '">' + 
							'<div class="cmsms_composer_column_head">' + 
								'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_delete" title="' + composerDeleteText + '">' + composerDeleteText + '</a>' + 
								'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_animation" title="' + composerCheckColumnText + '">' + composerCheckColumnText + '</a>' + 
								'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_copy" title="' + composerCopyText + '">' + composerCopyText + '</a>' + 
								'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_plus" title="' + composerPlusText + '">' + composerCopyText + '</a>' + 
								'<a href="#" class="cmsms_composer_column_button cmsms_composer_column_minus" title="' + composerMinusText + '">' + composerCopyText + '</a>' + 
								...
								'<span class="cmsms_composer_column_title">' + dTitle + '</span>' + 
							'</div>' + 
							'<div class="cmsms_composer_column_elements" data-folder="' + dFolder + '" data-type="' + dType + '" data-animation="' + dAnimation + '"></div>' + 
						'</div>');
					}
		...
		function updateComposerContent() { 
			...
			for (var i = 0, ilength = newValDivs.length; i < ilength; i += 1) {
				...
				if (cFolder !== 'divider') {
					newPostContent += '<div class="' + cClass + '" data-folder="' + cFolder + '" data-type="' + cType + '" data-animation="">' + newPostElementContent + '</div>';
				} else {
					newPostContent += '<div class="' + cClass + '" data-folder="' + cFolder + '" data-type="' + cType + '" data-animation="' + cAnimation + '">' + '<div class="' + ((cType === 'divider') ? 'divider' : 'cl') + '"></div>' + '</div>';
				}
			}
			...
			if (cFolder === 'divider') {
				...
				$('#cmsms_composer_content').append('<div class="' + cClass + '">' + 
					'<div class="cmsms_composer_column_head">' + 
						...
						'<span class="cmsms_composer_column_title">' + cTitle + '</span>' + 
					'</div>' + 
					'<div class="cmsms_composer_column_elements" data-folder="' + cFolder + '" data-type="' + cType + '" data-animation=""></div>' + 
				'</div>');
			}
		...
		$('.cmsms_composer_buttons_container > .cmsms_composer_buttons_container_wrap2 > a.button').bind('click', function () { 
			...
			$('#cmsms_composer_content').append('<div class="one_first">' + 
				...
				'</div>' + 
				'<div class="cmsms_composer_column_elements" data-folder="column" data-type="" data-animation="">' + composerShortcode + '</div>' + 
			'</div>');
		...
		// Change Composer Column Align
		$('#cmsms_composer_content').delegate('a.cmsms_composer_column_animation', 'click', function () { 
			var column = $(this).parent().parent(), 
				cIndex = column.index(), 
				cAnimation = (column.find('> div.cmsms_composer_column_elements').attr('data-animation')) ? column.find('> div.cmsms_composer_column_elements').attr('data-animation') : '', 
				cFolder = (column.find('> div.cmsms_composer_column_elements').attr('data-folder')) ? column.find('> div.cmsms_composer_column_elements').attr('data-folder') : 'column', 
				cTitle = column.find('> div.cmsms_composer_column_head > span.cmsms_composer_column_title').text(), 
				composerSHCodeText = $('#cmsms_composer_shortcode_text').val(), 
				composerUrl = $('#cmsms_composer_url').val();
